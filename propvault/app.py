...
<div class="guide-container">
    ...
    <div style="color: #f1f5f9; margin-bottom: 24px;">PropVault identifies price discrepancies by cross-referencing Pinnacle’s sharp-market liquidity against Draftking's live lines. When the "Fair Value" price is lower than the available odds, you have a mathematical edge.</div>
