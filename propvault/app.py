...
<div class="pv-header">
    <div class="pv-logo">
        <div>
            ...
            <div style="color:#475569; font-size:14px; font-weight:500;">Novig vs Pinnacle · Game Lines</div>
        </div>
    </div>
...
<div class="card strategy-box">
    ...
    <p style="color:#94a3b8; font-size:14px; line-height:1.7; margin:0;">
        ...
        <span class="s-stat-under">Unders return +3.33% ROI</span>. PropVault prioritizes 
        high-probability Game Lines where the math beats public bias.
    </p>
</div>
""", unsafe_allow_html=True)
